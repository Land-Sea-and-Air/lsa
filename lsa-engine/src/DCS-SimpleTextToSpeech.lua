...
STTS.DIRECTORY = os.getenv("STTS_DIRECTORY") or ""
STTS.SRS_PORT = tonumber(os.getenv("STTS_PORT")) or 5002 -- LOCAL SRS PORT - DEFAULT IS 5002
...
function STTS.TextToSpeech(message,freqs,modulations, volume,name, coalition,point, speed,gender,culture,voice, googleTTS )
    ...
    if STTS.DIRECTORY == nil or STTS.DIRECTORY == "" then
        return
    end
